      ...
      <div className="container flex justify-center">
        <div className="shadow-[inset_0px_20px_20px_10px_#00000024] p-11">
          <div>
            ...
            <button className="w-full mt-[30px] mb-[10px] p-1 bg-gray-500/30 shadow-[inset_0px_20px_20px_10px_#00000024]">Sign Up</button>
          </div>
          <p className="text-[14px]">Don't have an account? <span>Signup</span></p>
          <button className="w-full mt-[40px] mb-[10px] p-1 bg-gray-500/30 shadow-[inset_0px_20px_20px_10px_#00000024] flex gap-2 items-center justify-center"><FaGoogle />Sign Up with Google</button>
        </div>
      </div>
    </div>
  )
